...
unlabeled_folder = os.path.abspath('unlabeled/')
labeled_folder = os.path.abspath('labeled/')
...
labelSecond = tk.Label(text='https://github.com/lambdan/episode-detector - version ' + tool_version)
