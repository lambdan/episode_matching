#### Settings ####
unlabeled_folder = 'E:/MakeMKV/curb' # folder with unlabeled videos (disc1_title00.mkv, disc1_title01.mkv)
labeled_folder = 'Y:/TV Shows - Svensk text/Curb your enthusiasm/Season 1-6 (DVD)' # folder with labeled videos (s01e01.mp4, s01e02.mp4)
start_second = 30 # start later if theres a intro right at the start (default: 30)
compare_seconds = 10 # higher value = slower but more confident results. higher values might be a problem if the framerates differ (default: 10)
step_seconds = 1 # step through video at this rate (seconds) (default: 1)
match_avg = 75 # if avg is lower than this: move on (default: 75)
...
ffmpeg_options = '-loglevel error -vf scale=100:100'
...
if not os.path.exists (folder_for_comparisons):
	os.makedirs(folder_for_comparions)
